...
export const responseAPI = {
  submit: (surveyCode, answers, meta = {}) =>
    call("submit_response", { survey_code: surveyCode, answers: JSON.stringify(answers), ...meta }),
  saveDraft: (surveyCode, answers, responseId = null) =>
    call("save_draft", { survey_code: surveyCode, answers: JSON.stringify(answers), response_id: responseId }),
