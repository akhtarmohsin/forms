<template>
	<div class="flex h-screen overflow-hidden bg-gray-50">
		...
		<aside class="builder-sidebar flex flex-col">
			...
			<div class="flex-1 overflow-y-auto p-2" ref="sortableList">
				<div
					...
					:class="
						store.activeQuestionId === q.id
							? 'bg-blue-50 text-blue-700'
							: 'hover:bg-gray-100 text-gray-700'
					"
				>
					<span
						class="drag-handle select-none text-gray-300 group-hover:text-gray-400 text-xs"
						>⠿</span
					>
				...
				<div
					v-if="!store.survey.questions.length"
		...
		<aside
			v-if="store.activeQuestion && activeTab === 'Questions'"
			class="w-72 bg-white border-l border-gray-200 overflow-y-auto"
		>
			<QuestionSettings
